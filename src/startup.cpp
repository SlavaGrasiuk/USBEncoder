...
using intfunc = void(*const)(void);

[[using gnu: used, section(".isr_vector")]] const intfunc g_pfnVectors[] = {
	/* Core interrupt vectors */
...
#ifdef STM32F10X_HD
static_assert(sizeof g_pfnVectors / sizeof(*g_pfnVectors) == 16 + 60, "Wrong interrupt table size!");		//core + device vectors
#endif
